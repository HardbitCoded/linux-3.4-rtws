...
extern void task_rq_unlock(struct rq *rq, struct task_struct *p, unsigned long *flags);
...
struct root_domain {
    ...
    //Port from 2.6.36 RTWS
    /*
    * We keep track of each CPU current and earliest
    * stealable tasks deadline
    */
...
#define WEIGHT_RTWS                    0
#define WMULT_RTWS             1234567890
...
static void init_rtws_global_rq(struct global_rq *global_rq);
